...
export default class Package {
    ...
    async updateMetadata ( { commit, push, homepage, author, license, dependabot, github } = {} ) {
        ...
        if ( github && upstream.isGitHub && process.env.GITHUB_TOKEN ) {
            ...
            // private
            if ( this.cliConfig.meta.repository.private !== null && this.cliConfig.meta.repository.private !== res.data.private ) {
                data ??= {};
                data.private = this.cliConfig.meta.repository.private;
            }

            // visibility
            if ( this.cliConfig.meta.repository.visibility !== null && this.cliConfig.meta.repository.visibility !== res.data.visibility ) {
                data ??= {};
                data.visibility = this.cliConfig.meta.repository.visibility;
            }

            // issues
            if ( this.cliConfig.meta.repository.hasIssues !== null && this.cliConfig.meta.repository.hasIssues !== res.data.has_issues ) {
                data ??= {};
                data.has_issues = this.cliConfig.meta.repository.hasIssues;
            }

            // projects
            if ( this.cliConfig.meta.repository.hasProjects !== null && this.cliConfig.meta.repository.hasProjects !== res.data.has_projects ) {
                data ??= {};
                data.has_projects = this.cliConfig.meta.repository.hasProjects;
            }

            // wiki
            if ( this.cliConfig.meta.repository.hasWiki !== null && this.cliConfig.meta.repository.hasWiki !== res.data.has_wiki ) {
                data ??= {};
                data.has_wiki = this.cliConfig.meta.repository.hasWiki;
            }
