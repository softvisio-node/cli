...
import Documentation from "./package/documentation.js";
...
export default class Package {
    ...
    get softvisioConfig () {
        if ( !this.#softvisioConfig ) {
            if ( fs.existsSync( this.root + "/.softvisio.yaml" ) ) {
                this.#softvisioConfig = fs.config.read( this.root + "/.softvisio.yaml" );
            }
            else {
                this.#softvisioConfig = {};
            }
        }

        return this.#softvisioConfig;
    }
    ...
    get packages () {
        if ( this.#packages == null ) {
            ...
            const packages = this.softvisioConfig.packages;
    ...
    get lintConfig () {
        return this.softvisioConfig.lint;
    }

    get documentationConfig () {
        return this.softvisioConfig.documentation;
    }
