...
export default class Package {
    ...
    async updateDependencies ( { all, update, missing, internal = true, external = true, commit, yes, cache, outdatedDependencies } = {} ) {
        cache ||= {};
        ...
        if ( hasMissingDependencies && !missing ) updatable = false;
