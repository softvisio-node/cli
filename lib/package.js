...
export default class Package {
    ...
    async updateDependencies ( { all, updatable, outdated, workspace, missing, install, unlink, force, commit, quiet, yes, cache, outdatedDependencies } = {} ) {
        if ( !this.hasDependencies ) return result( 200 );
        ...
        if ( install && unlink && !force ) {
            force = await this.#hasLinkedPackages();
        }
