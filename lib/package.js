...
export default class Package {
    ...
    // XXX
    async checkOutdatedDependencies ( { update, updateMissed, commit } = {} ) {
        ...
        var hasMissedDependencies, updatable;
        ...
        if ( hasMissedDependencies && !updateMissed ) updatable = false;
