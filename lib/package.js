...
export default class Package {
    ...
    get commitsConfig () {
        if ( !this.#commitsConfig ) {
            this.#commitsConfig = config.read( "#resources/commits.json", { "resolve": import.meta.url } );

            this.#commitsConfig.types = new Set( this.#commitsConfig.types );
            this.#commitsConfig.scopes = new Set( this.#commitsConfig.scopes );
        }
