...
export default class Package {
    ...
    async #updateDependabotConfig () {
        ...
        // npm
        NPM: if ( this.cliConfig?.meta.dependabot.npm ) {
            const directories = [];
        ...
        // docker
        if ( this.cliConfig?.meta.dependabot.docker && this.hasDockerfile ) {
            updates.set( "docker", {
        ...
        // github-actions
        if ( this.cliConfig?.meta.dependabot[ "github-actions" ] && glob( ".github/workflows/*.*", { "cwd": this.root } ).length ) {
