...
export default class Package {
    ...
    async updateDependencies ( { all, updatable, outdated, workspace, missing, install, force, commit, quiet, yes, cache, outdatedDependencies } = {} ) {
        if ( !this.hasDependencies ) return result( 200 );
        ...
        install = install && ( hasUpdates || force );
