...
export default class Package {
    ...
    // XXX
    async updateMetadata ( { commit, push, homepage, author, license, dependabot, repository } = {} ) {
        env.loadUserEnv();
        ...
        if ( repository && upstream.isGitHub && process.env.GITHUB_TOKEN ) {
            ...
            // archived
            if ( repositorySettings.archived !== null && repositorySettings.archived !== currentData.archived ) {
                data ??= {};
