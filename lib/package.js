...
const validateCliConfig = new Ajv().compileFile( import.meta.resolve( "#resources/schemas/.softvisio-cli.schema.yaml" ) ),
    defaultCliConfig = readConfig( "#resources/.cli.yaml", { "resolve": import.meta.url } );
...
export default class Package {
    ...
    get cliConfig () {
        if ( !this.#cliConfig ) {
            ...
            if ( fs.existsSync( this.root + "/.cli.yaml" ) ) {
                cliConfig = mergeObjects( {}, defaultCliConfig, readConfig( this.root + "/.cli.yaml" ) );
            }
            else {
