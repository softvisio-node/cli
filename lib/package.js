...
export default class Package {
    ...
    get cliConfig () {
        if ( !this.#cliConfig ) {
            const defaultConfig = readConfig( "#resources/.softvisio-cli.yaml", { "resolve": import.meta.url } );

            if ( fs.existsSync( this.root + "/.softvisio-cli.yaml" ) ) {
                this.#cliConfig = mergeObjects( {}, defaultConfig, readConfig( this.root + "/.softvisio-cli.yaml" ) );
            }
            else {
                this.#cliConfig = mergeObjects( {}, defaultConfig );
            }
        }
