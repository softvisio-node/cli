...
export default class Package {
    ...
    async updateDependencies ( { update, all, updatable, missing, internal = true, external = true, quiet, commit, yes, cache, outdatedDependencies } = {} ) {
        cache ||= {};
        ...
        for ( const [ name, spec ] of Object.entries( outdatedDependencies ) ) {
            ...
            if ( updatable && spec.current === spec.wanted ) continue;
        ...
        // nothing to update
        if ( !update || !canUpdate ) return result( 200 );
