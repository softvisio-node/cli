...
export default class Package {
    ...
    async setRepositoryArchived ( archived ) {
        ...
        const res = await gitHubApi.updateRepository( upstream.repositorySlug, {
    ...
    async #updateDependabotConfig () {
        ...
        if ( this.cliConfig?.meta.dependabot.npm?.interval ) {
            ...
            if ( directories.length ) {
                updates.set( "npm", {
                    ...
                    "open-pull-requests-limit": this.cliConfig.meta.npm[ "open-pull-requests-limit" ],
                } );
            }
        }
        ...
        if ( this.cliConfig?.meta.dependabot.docker?.interval && this.hasDockerfile ) {
            updates.set( "docker", {
                ...
                "open-pull-requests-limit": this.cliConfig.meta.docker[ "open-pull-requests-limit" ],
            } );
        }
        ...
        if ( this.cliConfig?.meta.dependabot[ "github-actions" ]?.interval && ( await glob( ".github/workflows/*.*", { "cwd": this.root } ) ).length ) {
            updates.set( "github-actions", {
                ...
                "open-pull-requests-limit": this.cliConfig.meta.dependabot[ "open-pull-requests-limit" ],
            } );
        }
