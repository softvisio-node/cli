...
export default class Package {
    ...
    get commitsConfig () {
        if ( !this.#commitsConfig ) {
            ...
            this.#commitsConfig = {
                "strict": this.config.strict ?? defaultConfig.strict,
                "types": new Set( [...defaultConfig.types, ...( this.config.types || [] )] ),
                "requireScope": this.config.requireScope ?? defaultConfig.requireScope,
                "scopes": new Set( [...defaultConfig.scopes, ...( this.config.scopes || [] )] ),
            };
        }
    ...
    async publishNPM ( tag, latest ) {
        ...
        while ( 1 ) {
            try {
                console.log( "npm", "publish", "--tag", tag, "--access", "public", this.root );
        ...
        while ( 1 ) {
            try {
                console.log( "npm", "dist-tag", "add", this.name + "@" + this.version, "latest" );
