        ...
        for ( const name in outdatedDependencies ) {
            ...
            if ( updatable || outdated ) {
                ...
                for ( const spec of specs ) {
                    ...
                    if ( outdated ) {
                        ...
                        // not outdated dependency
                        if ( spec.wanted === spec.latest ) {
                            locations[ spec.location ] = false;
                        }
                    }

                    if ( locations[ spec.location ] !== false ) {
            ...
            for ( const spec of specs ) {
                ...
                if ( workspace != null ) {
                    ...
                    if ( workspace && !cache.workspacePackages.has( name ) ) continue;
                ...
                // not outdated can be updated to the latest version
                if ( spec.wanted === spec.latest ) {
                    spec.outdated = false;
                }

                // outdated, can not be updated to the latest version
                else {
                    spec.outdated = true;
                }
