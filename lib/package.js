...
export default class Package {
    ...
    async updateMetadata ( { archived, repository, homepage, author, license, dependabot, commit } = {} ) {
        var res;
        ...
        if ( repository ) {
            ...
            console.log( "Configure upstream repository:", res.ok
                ? ( res.data.updated
                    ? ansi.ok( " Updated " )
                    : "Not modified" )
                : ansi.error( " " + res.statusText + " " ) );
        ...
        // update metadata
        {
            ...
            console.log( "Update metadata:", res.ok
                ? ( res.data.updated
                    ? ansi.ok( " Updated " )
                    : "Not modified" )
                : ansi.error( " " + res.statusText + " " ) );
