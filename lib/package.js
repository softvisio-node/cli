...
export default class Package {
    ...
    get isDependenciesLocked () {
        return fs.existsSync( this.root + "/package-lock.json" ) || fs.existsSync( this.root + "/npm-shrinkwrap.json" );
    }
    ...
    async checkOutdatedDependencies ( { update, updateMissing, commit } = {} ) {
        ...
        console.log( "" );
        console.log( "Package:", this.workspacePath );
        ...
        if ( commit && this.isDependenciesLocked ) {
            ...
            if ( res.data.isDirty ) {
                ...
                // add changes
                res = await this.git.run( "add", "package-lock.json", "npm-shrinkwrap.json" );
                if ( !res.ok ) return res;
