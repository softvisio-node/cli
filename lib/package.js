    ...
    get monoRepositoryDirectory () {
        if ( this.#monoRepositoryDirectory === undefined ) {
            if ( this.parentPackage ) {
                this.#monoRepositoryDirectory = _path.posix.relative( this.parentPackage.root, this.root );
            }
            else {
    ...
    get cliConfig () {
        if ( !this.#cliConfig ) {
            if ( fs.existsSync( this.root + "/.cli.yaml" ) ) {
                this.#cliConfig = readConfig( this.root + "/.cli.yaml" );
            }
            else {
                this.#cliConfig = {};
            }
