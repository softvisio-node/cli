...
class Commit {
    ...
    // static
    static get HASH_SHORT_LENGTH () {
        return HASH_SHORT_LENGTH;
    }
    ...
    get hashShort () {
        if ( this.#hashShort === undefined ) {
            if ( !this.#hash ) this.#hashShort = null;
            else this.#hashShort = this.#hash.substr( 0, HASH_SHORT_LENGTH );
        }
