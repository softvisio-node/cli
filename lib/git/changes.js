...
export default class Changes {
    ...
    get hasFeatureNonBreakingChanges () {
        return !!this.featureNonBreakingChanges.length;
    }
    ...
    get hasFixNonBreakingChanges () {
        return !!this.fixNonBreakingChanges.length;
    }
    ...
    get hasOtherNonBreakingChanges () {
        return !!this.otherNonBreakingChanges.length;
    }
