...
export default class Priority {
    ...
    get breakingPriority () {
        return BREAKING_PRIORITY[ this.isBreakingChange ] || NO_BREAKING_PRIORITY;
    }
    ...
    get body () {
        this.#body ??= [ this.bodyText, this.headers.toString() ].filter( block => block ).join( "\n\n" );
