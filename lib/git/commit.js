...
export default class Commit extends Common {
    ...
    constructor ( { message, hash, abbrev, date, author, parentHashes } ) {
        super();
        ...
        if ( parentHashes ) {
            ...
            if ( !Array.isArray( this.#parentHashes ) ) {
                this.#parentHashes = [ this.#parentHashes ];
            }
        }
        else {
            this.#parentHashes = [];
