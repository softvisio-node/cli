    ...
    #getChangesGroups () {
        if ( !this.#changesGroups ) {
            this.#changesGroups = {
                ...
                "Features": {
                    "changes": this.#changes.getChanges( change => change.isFeature && !change.isBreakingChange ),
                    "showAnnotatiion": true,
                },
                "Fixes": {
                    "changes": this.#changes.getChanges( change => change.isFix && !change.isBreakingChange ),
                    "showAnnotatiion": true,
                },
                "Other changes": {
                    "changes": this.#changes.getChanges( change => change.isOther && !change.isBreakingChange ),
                    "showAnnotatiion": true,
                },
