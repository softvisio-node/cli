...
module.exports.getFiles = function getFiles ( patterns, options ) {
    var files = {};
    ...
    var extensions;
    if ( options.ext && options.ext.length ) extensions = Object.fromEntries( options.ext.map( ext => [ext, true] ) );
    ...
    files = Object.keys( files ).filter( file => {
        ...
        if ( extensions && !extensions[_path.extname( file )] ) return false;
