...
module.exports = class extends Command {
    ...
    async _installGlobal () {
        ...
        fs.copyFileSync( require.resolve( "#resources/pre-commit" ), hooksPath.data + "/pre-commit" );
    ...
    async _installLocal () {
        ...
        fs.copyFileSync( require.resolve( "#resources/pre-commit" ), hooksPath + "/pre-commit" );
