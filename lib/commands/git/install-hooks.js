...
export default class extends Command {
    ...
    async _installGlobal () {
        ...
        fs.copyFileSync( fs.resolve( "#assets/pre-commit", import.meta.url ), hooksPath.data + "/pre-commit" );
    ...
    async _installLocal () {
        ...
        fs.copyFileSync( fs.resolve( "#assets/pre-commit", import.meta.url ), hooksPath + "/pre-commit" );
