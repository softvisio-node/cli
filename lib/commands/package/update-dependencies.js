    ...
    static cli () {
        return {
            "options": {
                ...
                "not-updatable": {
                    "short": "U",
                    "description": "show not-updatable dependencies only",
                    "default": false,
                    "schema": {
                        "type": "boolean",
                    },
    ...
    async run () {
        ...
        for ( const pack of [ pkg, ...( process.cli.options[ "sub-packages" ]
            ...
            const res = await pack.updateDependencies( {
                ...
                "updatable": process.cli.options.updatable && process.cli.options[ "not-updatable" ]
                    ? null
                    : process.cli.options.updatable
                        ? true
                        : process.cli.options[ "not-updatable" ]
                            ? false
                            : null,
