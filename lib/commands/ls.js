...
module.exports = class extends Command {
    static cli () {
        return {
            ...
            "options": {
                ...
                "dirty": {
                    "summary": `Show all projects regardless to the "dirty" or "unreleased" status. "Dirty" project - project, that has uncommited or unpushed changes.`,
                    "default": true,
                    "schema": { "type": "boolean" },
                },
                "unreleased": {
                    "summary": `Show unreleased projects.`,
                    "default": false,
                    "schema": { "type": "boolean" },
                },
            },
    ...
    async #lsWorkspace ( name, path, options ) {
        ...
        for ( const root of projects ) {
            ...
            const isDirty = id.data.isDirty || currentBranchPushStatus,
                isUnreleased = ( id.data.currentRelease && id.data.currentReleaseDistance ) || ( !id.data.branch && id.data.hashShort );
