    ...
    static cli () {
        return {
            ...
            "options": {
                ...
                "private": {
                    "short": "P",
                    "description": "list private projects only",
                    "default": false,
                    "schema": { "type": "boolean" },
                },
                "public": {
                    "short": "p",
                    "description": "list public projects only",
                    "default": false,
                    "schema": { "type": "boolean" },
                },
                "unreleased": {
                    "description": `show unreleased projects only, regardless to the "dirty" status`,
                    "default": false,
                    "schema": { "type": "boolean" },
                },
                "dirty": {
                    "description": `Show all projects regardless to the "dirty" status. "Dirty" project - project, that has uncommited or unpushed changes.`,
                    "default": true,
                    "schema": { "type": "boolean" },
                },
            },
