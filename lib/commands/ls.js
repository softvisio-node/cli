...
module.exports = class extends Command {
    static cli () {
        return {
            ...
            "options": {
                ...
                "dirty": {
                    "summary": `Show all projects regardless to the "dirty" status.`,
                    "default": true,
                    "schema": { "type": "boolean" },
                },
            },
    ...
    async _lsWorkspace ( name, path, options ) {
        ...
        for ( const root of projects ) {
            ...
            const projectIsDirty = id.data.isDirty || currentBranchPushStatus || ( id.data.currentRelease && id.data.currentReleaseDistance );
