...
module.exports = class extends Command {
    ...
    async _lsWorkspace ( name, path, options ) {
        ...
        const table = new Table( {
            "console": true,
            "columns": {
                "1": { "title": ansi.hl( "PROJECT NAME" ) },
                "2": { "title": ansi.hl( "BRANCH" ), "width": 15 },
                "3": { "title": ansi.hl( "IS DIRTY" ), "width": 10 },
                "4": { "title": ansi.hl( "NOT\nPUSHED" ), "width": 8 },
                "5": { "title": ansi.hl( "LATEST\nRELEASE" ), "width": 19 },
                "6": { "title": ansi.hl( "CURRENT\nRELEASE" ), "width": 19 },
                "7": { "title": ansi.hl( "UNRELEASED\nCHANGES" ), "width": 12 },
            },
        } );
        ...
        for ( const root of projects ) {
            ...
            table.add( [
                ...
                //
                ( isPrivate ? ansi.error( " PRIV " ) : ansi.ok( "  PUB " ) ) + " " + ansi.hl( rootPackage.name ),
                id.data.branch || ( id.data.hashShort ? "HEAD: " + ansi.error( id.data.hashShort ) : "" ),
