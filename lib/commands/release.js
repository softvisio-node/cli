...
module.exports = class extends Command {
    ...
    async run () {
        ...
        const latest = Object.keys( releases.data ).reverse()[0] === CONST.VERSION_PREFIX + version ? true : false;
        ...
        if ( await git.getUpstream() ) {
            ...
            while ( 1 ) {
                ...
                res = await git.run( "push", "origin", "-f", `refs/tags/${CONST.VERSION_PREFIX + newVersion}`, latest ? "refs/tags/latest" : "" );
