...
export default class extends Command {
    ...
    #parse ( string, messages ) {
        try {
            var ast = babelParser.parse( string, {
                "sourceType": "module",
            } );
        }
        catch ( e ) {
