        ...
        for ( const file of process.cli.arguments.files ) {
            ...
            if ( file.endsWith( ".vue" ) ) {
                ...
                if ( sfc.descriptor?.script?.content ) {
                    this.#parse( messages.sfc.descriptor.script.content, parseEspree, { "sourceType": "module", "ecmaVersion": "latest", "loc": true }, file );
                }
            }
            ...
            // .js, .mjs
                ...
                this.#parse( messages, content, parseEspree, { "sourceType": "module", "ecmaVersion": "latest", "loc": true, "comment": true }, file );
            }
        }
