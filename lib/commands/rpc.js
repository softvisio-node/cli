...
import { toMsgPack, fromMsgPack } from "@softvisio/core/msgpack";
...
export default class extends Command {
    ...
    async run () {
        ...
        var server = net.createServer( socket => {
            ...
            const decoder = fromMsgPack.pipe( socket );
            ...
            decoder.on( "data", async msg => {
                try {
                    ...
                    socket.write( toMsgPack( [1, msg[1], "error", null] ) );
                }
            } );
        } );
...
${data.data}
    ...
    async CMD_src ( data ) {
        const { "default": File } = await import( "../src/file.cjs" ),
