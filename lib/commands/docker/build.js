...
export default class extends Command {
    ...
    static cli () {
        return {
            "options": {
                ...
                "compose-file": {
                    "description": `Compose file to build. Default is "docker-compose.yaml".`,
                    "schema": {
                        "type": "arrau",
                        "items": { "type": "string" },
                        "uniqueItems": true,
    ...
    async run () {
        ...
        else if ( cliConfig.docker?.build.composeFile ) {
            composeFiles = cliConfig.docker?.build?.composeFile;
        }
        else {
