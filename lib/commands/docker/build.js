...
const validate = new Ajv().compile( config.read( "#core/resources/schemas/docker.stack.schema.yaml", { "resolve": import.meta.url } ) );
...
export default class extends Command {
    ...
    async run () {
        ...
        for ( const service of services ) {
            ...
            const res = childProcess.spawnSync( "docker",
                [
