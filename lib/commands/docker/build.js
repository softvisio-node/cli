...
export default class extends Command {
    ...
    static cli () {
        return {
            ...
            "arguments": {
                "commit-id": {
                    "description": "Git commit id to build. If not specified current branch name will be used.",
                    "schema": { "type": "string" },
                },
            },
        };
    ...
    async run () {
        ...
        for ( const composeFile of composeFiles ) {
            ...
            const builder = new DockerBuilder( pkg.root, {
                ...
                "commitId": process.cli.arguments[ "commit-id" ] || cliConfig.docker?.defaultTag,
