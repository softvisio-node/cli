...
export default class Docs {
    ...
    async #buildDefault ( options ) {
        ...
        // index.html
        {
            ...
            // generate index.html
            const index = fileTree.add( { "path": "index.html", "data": await ejs.renderFile( fs.resolve( "#resources/templates/docs/index.html", import.meta.url ), options ) } );
    ...
    #copyNoJekyll () {
        fs.copyFileSync( fs.resolve( "#resources/templates/docs/.nojekyll", import.meta.url ), this.#rootPackage.root + "/" + DEFAULT_DOCS_LOCATION + "/.nojekyll" );
    }
}
