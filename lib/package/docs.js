...
export default class Docs {
    ...
    async #init () {
        ...
        fileTree.add( { "path": ".config.yaml", "data": await ejs.renderFile( fs.resolve( "#assets/templates/docs/.config.yaml", import.meta.url ), {} ) } );
    ...
    async #buildDefault ( options ) {
        ...
        if ( !fs.existsSync( this.#rootPackage.root + "/" + DEFAULT_DOCS_LOCATION + "/README.md" ) ) {
            fileTree.add( { "path": "README.md", "data": await ejs.renderFile( fs.resolve( "#assets/templates/docs/README.md", import.meta.url ), options ) } );
        }

        // generate default sidebar
        if ( !fs.existsSync( this.#rootPackage.root + "/" + DEFAULT_DOCS_LOCATION + "/_sidebar.md" ) ) {
            fileTree.add( { "path": "_sidebar.md", "data": await ejs.renderFile( fs.resolve( "#assets/templates/docs/_sidebar.md", import.meta.url ), options ) } );
        }
        ...
        // index.html
        {
            ...
            // generate index.html
            const index = fileTree.add( { "path": "index.html", "data": await ejs.renderFile( fs.resolve( "#assets/templates/docs/index.html", import.meta.url ), options ) } );
    ...
    async #buildReadme ( options ) {
        ...
        const template = fs.resolve( "#assets/templates/docs/README.main.md", import.meta.url ),
            fileTree = new fs.FileTree();
    ...
    #copyNoJekyll () {
        fs.copyFileSync( fs.resolve( "#assets/templates/docs/.nojekyll", import.meta.url ), this.#rootPackage.root + "/" + DEFAULT_DOCS_LOCATION + "/.nojekyll" );
    }
}
