...
export default class Docs {
    ...
    async init () {
        ...
        // check docs config
        if ( !this.location ) throw result( [ 404, `Documentation config wasn't found` ] );
    ...
    async #buildAppSchemas ( options, { lint } = {} ) {
        ...
        const componentsUrl = resolve( "@softvisio/core/app/components", url.pathToFileURL( this.#rootPackage.root + "/lib/app.js" ), { "url": true } ),
