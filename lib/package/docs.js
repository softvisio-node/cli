...
export default class Docs {
    ...
    async #init () {
        ...
        if ( fs.existsSync( this.#rootPackage.root + "/README.md" ) ) {
            fs.copySync( this.#rootPackage.root + "/README.md", this.#rootPackage.root + "/" + DEFAULT_DOCS_LOCATION + "/README.md" );
        }
    }
    ...
    async #buildDefault ( options ) {
        ...
        // generate .nojekyll
        fileTree.add( { "path": ".nojekyll", "data": await ejs.renderFile( fs.resolve( "#resources/templates/docs/docs/.nojekyll", import.meta.url ), options ) } );
