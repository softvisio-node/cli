...
export default class Docs {
    ...
    async #buildOptions () {
        ...
        //         changelogURL = new URL( "main/CHANGELOG.md", upstream.rawURL + "/" ).href;
        //     }
        //     else {
        //         changelogURL = new URL( "./" + config.changelog, upstream.rawURL + "/" ).href;
        //     }
        // }
        ...
        // favicon
        if ( config.favicon ) {
            options.favicon = config.favicon;
        }
        ...
        // top links
        if ( options.changelogURL ) options.links.push( { "title": "CHANGELOG", "iconCls": null, "href": options.changelogURL } );
        if ( options.discussionsURL ) options.links.push( { "alt": "Discussions", "iconCls": "far fa-comments", "href": options.discussionsURL } );
        if ( options.issuesURL ) options.links.push( { "alt": "Issues", "iconCls": "fas fa-bug", "href": options.issuesURL } );
        if ( options.npmURL ) options.links.push( { "alt": "NPM package", "iconCls": "fab fa-npm", "href": options.npmURL } );
        if ( options.sourceURL ) options.links.push( { "alt": "Source code", "iconCls": "fab fa-github", "href": options.sourceURL } );
