...
export default class Documentation {
    ...
    async build () {
        ...
        // check wiki exists
        if ( !this.isExists ) return this.#done( result( [404, `Documentation config wasn't fount.`] ) );

        if ( !this.#rootPackage.documentationConfig.api || !this.#rootPackage.documentationConfig.api.length ) return this.#done( result( [404, `API documentation config wasn't fount.`] ) );
