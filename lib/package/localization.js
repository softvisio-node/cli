                    ...
                    if ( message.isTranslated && !message.isFuzzy ) {
                        if ( translatedMessage ) {
                            ...
                            if ( translatedMessageHash !== messageHash ) {
                                console.log( `Translation memory conflict:
- [en]: ${ message.id }
- [en]: ${ message.pluralId || "-" }

Old translations:
- [${ poFile.language }]: ${ JSON.stringify( translatedMessage.translations, null, 4 ) }

New translations:
- [${ poFile.language }]: ${ JSON.stringify( message.translations, null, 4 ) }
` );
