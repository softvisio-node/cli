...
You need to merge with the "${ latestPreRelease.versionString }" first.`,
        ...
        while ( true ) {
            ...
            res = await git.exec( [ "commit", "-m", `chore: release ${ this.#newVersion.versionString }` ] );
        ...
        while ( true ) {
            ...
            res = await git.exec( [ "tag", "-a", this.#newVersion.versionString, "-m", `Release version: ${ this.#newVersion.versionString }` ] );
        ...
        if ( this.#upstream ) {
            ...
            if ( this.#upstream.hosting === "github" && process.env.GITHUB_TOKEN ) {
                ...
                while ( true ) {
                    ...
                    res = await github.createRelease( this.#upstream.repositorySlug, this.#newVersion.versionString, {
