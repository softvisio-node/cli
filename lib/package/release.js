...
export default class Publish {
    ...
    async run () {
        ...
        // define new version
        try {
            this.#currentRelease = ( this.#changelog.currentRelease || this.#changelog.previousRelease || GitRelease.initialVersion ).increment( this.#changelog.hasBreakingChanges
                ? "major"
    ...
    async #updateChangelog () {
        ...
        // linkify changelog
        if ( this.#upstream ) {
            fullChangelogText = this.#upstream.linkifyMessage( fullChangelogText );
        }
        ...
        // write CHANGELOG.md
        fs.writeFileSync( this.#pkg.root + "/CHANGELOG.md", fullChangelogText );
