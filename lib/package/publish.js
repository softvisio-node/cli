...
You need to merge first.`,
        ...
        this.#nextTag = this.#newVersion.gt( id.releases.last ) ? "next" : "";
...
You need to merge with the "${latestPreRelease.toVersionString()}" first.`,
        ...
        if ( this.#upstream ) {
            while ( 1 ) {
                ...
                // XXX
                res = await git.run( "push", "--atomic", "origin", id.branch, this.#newVersion.toVersionString(), this.#nextTag, "latest", "--force" );
