...
export default class Publish {
    ...
    async run () {
        ...
        this.#latestTag = !this.#newVersion.isPreRelease && this.#newVersion.gt( id.releases.latest ) ? "latest" : "";
        this.#latestMajorTag = id.releases.isLatestMajor( this.#newVersion ) ? `latest.${this.#newVersion.major}` : "";
