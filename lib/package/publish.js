...
You need to merge first.`,
        ...
        this.#latestTag = !this.#newVersion.isPreRelease && this.#newVersion.gt( status.releases.latest ) ? "latest" : "";
        this.#nextTag = this.#newVersion.gt( status.releases.next ) ? "next" : "";

        const latestPreRelease = status.releases.getLatestPreRelease( this.#newVersion );
