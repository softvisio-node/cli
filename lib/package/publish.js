...
You need to merge first.`,
        ...
        this.#nextTag = this.#newVersion.gt( id.releases.next ) ? "next" : "";
...
You need to merge with the "${latestPreRelease.toVersionString()}" first.`,
        ...
        if ( this.#upstream ) {
            while ( 1 ) {
                ...
                const params = ["push", "--atomic", "--force", "origin", id.branch, this.#newVersion.toVersionString(), this.#nextTag, this.#latestTag].filter( param => param != null && param !== "" );
