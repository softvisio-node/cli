...
export default class Publish {
    ...
    async run () {
        ...
        if ( id.versions[this.#newVersion.base] ) return result( [500, `Version "${this.#newVersion.base}" is already released on the other branch`] );
        ...
        for ( const version of Object.values( id.versions ) ) {
            console.log( version + "", version.base + "" );
            ...
            if ( this.#newVersion.isPreRelease && version.gt( this.#version ) && version.lt( this.#newVersion ) ) {
                return result( [500, `Version "${version}" is already released on the other branch`] );
            }
