    ...
    #parseCallExpressionArgument ( node, location ) {
        ...
        if ( node.type === "Literal" ) {
            ...
            if ( node.quasis.length === 1 ) {
                ...
                return result( [500, `Template literal with arguments must be tagged with the "msgid" tag`] );
            }
        }
            ...
            if ( node.tag.name === "msgid" ) {
                ...
                return result( [500, `Tagged template literal must be tagged with the "msgid" tag`] );
            }
        }
