...
const cliConfigSchema = new Ajv().addSchema( await readConfig( import.meta.resolve( "#resources/schemas/ccli.config.schema.yaml" ) ) ),
    defaultCliConfig = await readConfig( "#resources/ccli.config.yaml", { "resolve": import.meta.url } );
