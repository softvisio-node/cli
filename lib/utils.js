...
module.exports.lintReport = function ( report ) {
    console.log( `
Total files: ${report.total}, ignored: ${report.ignored}, processed: ${report.processed}, modified: ${report.modified}
Warnings: ${ansi.warn( " " + report.warnings + " " )}, Errors: ${ansi.error( " " + report.errors + " " )}
        ` );
};
