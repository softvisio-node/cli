...
export default class {
    ...
    get git () {
        this.#git ??= new Git( this.root + "/dists" );
    ...
    async #prune () {
        ...
        const deleted = fs
            .readFileSync( this.root + "/dists/.git/filter-repo/analysis/path-deleted-sizes.txt", "utf8" )
            .split( "\n" )
            .slice( 2 )
    ...
    #deleteFilterRepo () {
        fs.rmSync( this.root + "/dists/.git/filter-repo", {
            "recursive": true,
            "force": true,
        } );
    }
