...
export default class {
    ...
    async update () {
        ...
        res = await this.#deleteOldPackages();
        if ( !res.ok ) return res;
    ...
    async #deleteOldPackages () {
        ...
        for ( const file of files ) {
            const dist = await this.#getDistInfo( this.root + "/dists/" + file );
        ...
        for ( let dists of Object.values( packages ) ) {
            ...
            for ( const dist of dists ) {
                ...
                fs.rmSync( this.root + "/dists/" + dist.file );
            }
        }
