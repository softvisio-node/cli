...
const RESOURCES_ROOT = path.dirname( fs.resolve( "#assets/.prettierrc.yaml", import.meta.url ) );
...
const DEFAULT_ESLINT_CONFIG_JAVASCRIPT = fs.resolve( "#assets/.eslintrc.javascript.cjs", import.meta.url );
const DEFAULT_ESLINT_CONFIG_TYPESCRIPT = fs.resolve( "#assets/.eslintrc.typescript.cjs", import.meta.url );
const DEFAULT_ESLINT_CONFIG_JEST = fs.resolve( "#assets/.eslintrc.jest.cjs", import.meta.url );
