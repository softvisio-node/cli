...
const DEFAULT_PRETTIER_CONFIG = prettier.resolveConfig.sync( __dirname + "/../../resources/1.txt", {
    "editorconfig": true,
    "config": __dirname + "/../../resources/.prettierrc.yaml",
} );

const DEFAULT_ESLINT_CONFIG_JAVASCRIPT = path.resolve( __dirname, "../../resources/.eslintrc.javascript.js" );
const DEFAULT_ESLINT_CONFIG_TYPESCRIPT = path.resolve( __dirname, "../../resources/.eslintrc.typescript.js" );
...
module.exports = class {
    ...
    constructor ( filePath, options = {} ) {
        ...
        this.#noIgnore = options.noIgnore;
    ...
    async #compress () {
        if ( this.#type ) {
            if ( this.#type.terser ) {
                return this.#terser( { "compress": true, "mangle": false } );
            }
    ...
    async #obfuscate () {
        if ( this.#type ) {
            if ( this.#type.terser ) {
                return this.#terser( { "compress": true, "mangle": true } );
            }
            else if ( this.#type.cssnano ) {
