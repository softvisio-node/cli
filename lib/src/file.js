...
const TYPE = {
    ...
    "text/yaml": { "parser": "yaml", "singleQuote": true },
...
module.exports = class {
    ...
    static getFileType ( filename, data ) {
        var type = TYPE[( mime.getByFilename( filename ) || {} ).id];

        if ( !type ) {
            if ( data != null ) {
                type = ( mime.getByShebang( data ) || {} ).id;
            }
            else {
                ...
                type = ( mime.getByShebang( buf.toString() ) || {} ).id;
            }
        }
    ...
    async _lint () {
        ...
        if ( this.#type ) {
            ...
            if ( this.#type.parser ) {
                ...
                if ( typeof this.#type.singleQuote === "boolean" ) config.singleQuote = this.#type.singleQuote;
