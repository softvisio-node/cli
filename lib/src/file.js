...
const DEFAULT_PRETTIER_ROOT = path.dirname( require.resolve( "#resources/.prettierrc.yaml" ) );
const DEFAULT_PRETTIER_CONFIG_PATH = DEFAULT_PRETTIER_ROOT + "/.prettierrc.yaml";
const DEFAULT_PRETTIER_CONFIG = prettier.resolveConfig.sync( DEFAULT_PRETTIER_ROOT + "/1.txt", {
    "editorconfig": true,
    "config": DEFAULT_PRETTIER_CONFIG_PATH,
} );

const DEFAULT_ESLINT_CONFIG_JAVASCRIPT = require.resolve( "#resources/.eslintrc.javascript.cjs" );
const DEFAULT_ESLINT_CONFIG_TYPESCRIPT = require.resolve( "#resources/.eslintrc.typescript.cjs" );
...
module.exports = class {
    ...
    async #lint () {
        ...
        // fallback to the default config
            ...
            config = prettier.resolveConfig.sync( DEFAULT_PRETTIER_ROOT + "/" + path.basename( this.#path ), {
                "editorconfig": true,
                "config": DEFAULT_PRETTIER_CONFIG_PATH,
            } );
        }
    ...
    async #eslint ( indent ) {
        ...
        // fallback to the default config
            ...
            const options = {
                ...ESLINT_OPTIONS,
                "overrideConfigFile": this.#type.parser === "typescript" ? DEFAULT_ESLINT_CONFIG_TYPESCRIPT : DEFAULT_ESLINT_CONFIG_JAVASCRIPT,
                "useEslintrc": false,
            };
