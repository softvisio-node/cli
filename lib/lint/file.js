...
const customMime = mime.clone().add( Object.entries( await readConfig( "#resources/mime.yaml", { "resolve": import.meta.url } ) ).map( ( [ essence, type ] ) => {
        type.essence = essence;

        return type;
    } ) ),
    DEFAULT_ESLINT_CONFIG_JAVASCRIPT = import.meta.resolve( "#resources/eslint.config.javascript.js" ),
