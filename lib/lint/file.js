...
export default class LintFile {
    ...
    constructor ( file, { data, processUnsupported, write, defaults } = {} ) {
        this.#file = file;
        this.#data = data;
    ...
    // private
    async #lint () {
console.log( this.#defaults );process.exit()
...
// |==========+==========+==========================================================================|
// | ERROR    |    220:5 | no-unused-private-class-members, '#defaults' is defined but never used.  |
// +----------+----------+--------------------------------------------------------------------------+
//
