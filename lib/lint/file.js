...
export default class LintFile {
    ...
    constructor ( file, { data, processUnsupported, write, useDefault, cache } = {} ) {
        this.#file = file;
        this.#data = data;
        this.#processUnsupported = !!processUnsupported;
        this.#write = !!write;
        this.#cache = cache || {};
        this.#useDefault = useDefault ?? this.#getUseDefaults( this.#file.path );
    }
    ...
    async #lint () {
        ...
        if ( this.#type ) {
            ...
            // run prettier
            if ( this.#useDefault && this.#type.prettier?.parser ) {
                config.plugins ??= [];
    ...
    #getUseDefaults ( dir ) {
        ...
        while ( true ) {
            if ( dir in this.#cache ) return this.#cache[ dir ];
