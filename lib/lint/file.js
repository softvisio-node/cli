...
export class LintFile {
    ...
    async #lint () {
        ...
        // XXX remove
        editorConfig.end_of_line ||= prettierConfig.endOfLine;
        editorConfig.indent_style ||= prettierConfig.useTabs ? "tab" : "space";
        editorConfig.indent_size ||= prettierConfig.tabWidth || 4;
        ...
        if ( editorConfig ) {
            ...
            if ( editorConfig.indent_style === "space" ) {
                this.#replaceTabs( editorConfig.indent_size );
            }
