    ...
    async #lint () {
        ...
        if ( this.#type ) {
            ...
            if ( this.#type.eslint ) {
                ...
                res = await this.#runEslint( config?.useTabs ? "tab" : config?.tabWidth );
        ...
        if ( this.#useDefaults || this.#processUnsupported ) {

            // cut trailing spaces
            // XXX use EOL from config
            // XXX preserve EOL
