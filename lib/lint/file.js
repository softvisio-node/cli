        ...
        if ( eslintConfig === true ) {
            ...
            if ( editorConfig ) {
                ...
                if ( editorConfig.max_line_length ) {
                    options.overrideConfig.rules[ "@stylistic/max-len" ] = [
                        "error",
                        {
                ...
                options.overrideConfig.rules[ "@stylistic/eol-last" ] = [ "error", editorConfig.insert_final_newline ? "always" : "never" ];

                // override @stylistic/no-trailing-spaces
                options.overrideConfig.rules[ "@stylistic/no-trailing-spaces" ] = [
                    "error",
                    {
