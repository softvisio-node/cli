...
export class LintFile {
    ...
    async #lint () {
        ...
        if ( this.#type?.eslint ) {
            res = await this.#runEslint( {
                configs,
                "indent": editorConfig?.indent_style === "tab" ? "tab" : editorConfig?.indent_size,
            } );
    ...
    async #runEslint ( { configs, indent } ) {
        ...
        if ( eslintConfig === true ) {
            ...
            // override @stylistic/indent rule
            if ( indent ) {
                options.overrideConfig.rules[ "@stylistic/indent" ] = [ "error", indent ];
            }
        }
...
// |==========+==========+==========================================================================|
// | ERROR    |     10:8 | no-unused-vars, 'PrettierPluginSh' is defined but never used.            |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |     11:8 | no-unused-vars, 'PrettierPluginPackageJson' is defined but never used.   |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |     12:8 | no-unused-vars, 'PrettierPluginXml' is defined but never used.           |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |   366:17 | no-undef, 'prettierconfig' is not defined.                               |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |   367:17 | no-undef, 'prettierconfig' is not defined.                               |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |   367:46 | no-undef, 'prettierpluginsh' is not defined.                             |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |   367:64 | no-undef, 'prettierpluginpackagejson' is not defined.                    |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |   367:91 | no-undef, 'prettierpluginxml' is not defined.                            |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |   368:17 | no-undef, 'prettierconfig' is not defined.                               |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |   369:17 | no-undef, 'prettierconfig' is not defined.                               |
// +----------+----------+--------------------------------------------------------------------------+
//
